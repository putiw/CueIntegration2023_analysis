function [trainedClassifier, validationAccuracy] = subKNN(trainingData)
...
% Auto-generated by MATLAB on 01-Feb-2023 04:11:57
...
labelname = [repelem('voxel',size(trainingData,2),1) num2str((1:size(trainingData,2))','%04.f')];
labelname = reshape(table2cell(table(labelname)),1,size(table2cell(table(labelname)),1));
inputTable = array2table(trainingData, 'VariableNames', labelname);

predictorNames = labelname(1:end-1);
