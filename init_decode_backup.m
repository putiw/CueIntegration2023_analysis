function [datafiles,nuisance,roimask,R2,label,dsCon,dsTrial,dataDim,param] = init_decode_backup(sub)
...
param.drop = '/Users/pw1246/Dropbox (RVL)/2022 Human 3D Motion Cue Isolation/backup_expFiles';
...
dsConAll = [];
hrf = getcanonicalhrf(3,param.TR);
...
datafiles = load_data(param.bids,'Cue','fsnative','.mgh',param.sub,param.ses,runNum);
%%
